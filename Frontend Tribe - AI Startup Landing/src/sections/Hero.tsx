...
export const Hero = () => {
	...
	return (
		...
		>
			...
			{/* Start Planet */}
			<div className="absolute h-64 w-64 md:h-96 md:w-96 bg-purple-500 rounded-full border border-white/20 custom-position bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[-20px_-20px_50px_rgb(255,255,255,.5),-20px_-20px_80px_rgb(255,255,255,.1),0_0_50px_rgb(140,69,255)]"></div>
			{/* End Planet */}
			{/* Ring 1 */}
			<motion.div
				...
				className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] border opacity-20 rounded-full custom-position"
			>
			...
			<motion.div
				...
				className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border md:border-2 border-white/20 rounded-full custom-position border-dashed"
			></motion.div>
			{/* Ring 3 */}
			<motion.div
				animate={{ rotate: "1turn" }}
				style={{ translateX: "-50%", translateY: "-50%" }}
				transition={{ repeat: Infinity, duration: 90, ease: "linear" }}
				className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] border opacity-20 rounded-full custom-position"
			>
				<div className="absolute h-2 w-2 bg-white rounded-full top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 "></div>
